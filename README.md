...
Check out this [screenshot](http://mike4aday.github.io/SwiftlySalesforce/images/ConnectedAppSettings.png) for an example Connected App definition. Note that the checkbox for "Require Secret for Refresh Token Flow" should *not* be selected.
