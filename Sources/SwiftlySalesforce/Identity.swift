...
/// See [Identity URLs](https://help.salesforce.com/HTViewHelpDoc?id=remoteaccess_using_openid.htm).
...
extension Identity: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.lastModifiedDate = try {
            // In Winter '19 version, date format changed for this field so we need to try both
